...
/**
 *
 * @author http://www.csee.umbc.edu/~squire/math/Complex.java
 */
public strictfp class Complex extends Object {
    ...
    public Complex cartesian() {
        return new Complex(this.x * StrictMath.cos(this.y),
    ...
    public Complex divide(Complex z) {
        ...
        return new Complex((this.x * z.x + this.y * z.y) / r,
    ...
    /**
     * convert a complex number to a String. Complex z = new Complex(1.0,2.0);
    ...
    /**
     * convert text representation to a Complex. input format
     ...
     */
    public Complex sin() {
        return new Complex(StrictMath.sin(this.x) * cosh(this.y),
     ...
     */
    public Complex cos() {
        return new Complex(StrictMath.cos(this.x) * cosh(this.y),
     ...
     */
    public Complex sinh() {
        return new Complex(sinh(this.x) * StrictMath.cos(this.y),
     ...
     */
    public Complex cosh() {
        return new Complex(cosh(this.x) * StrictMath.cos(this.y),
    ...
    public Complex atanh() {
        return (((this.add(1.0)).log()).subtract(
